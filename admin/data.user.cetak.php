...
include "../aksi/func.halaman.cetak.php";
session_start();
...
<table width="600" border="0" class="table table-responsive table-hover table-striped table-bordered">
    ...
    foreach ($dataTable as $i => $data)
    {
		...
		?>
         <td><a href="cetak.php?id=<?php echo $data['id_user']; ?>"><button type="button" class="btn btn-default btn-sm" title="Cetak Kartu">cetak</button></a></td>
