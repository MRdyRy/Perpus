<link rel="stylesheet" href="../admin/pengaturan/css/bootstrap.min.css" />
<?php
include "../koneksi.php";
//include "admin/inc.nama.user.php";
include "../aksi/func.halaman.caribuku.php";
session_start();
...
<table width="600" border="0" class="table table-responsive table-hover table-striped table-bordered">
    ...
    foreach ($dataTable as $i => $data)
    {
		...
		?>
         <td><a href="bacaebookn.php?id=<?php echo $data['id_file']; ?>"><button type="button" class="btn btn-primary btn-sm" title="Baca"><span class="glyphicon glyphicon-search"></span></button></a></td>
