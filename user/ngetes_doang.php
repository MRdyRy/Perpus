...
<td><a href="#" class="popovernya"><img data-container="body" data-toggle="popover" data-content="<button class="btn btn-primary">Upload Foto</button>" class="img-responsive img-rounded img-thumbnail" height="114px;" width="92px" src="<?php echo $lokasi_foto;?>"><?php } ?></a></td></td>
</tr>
<tr>
<td>NPM</td>
<td id="data">:</td>
...
$(function () { $('#infoakti').collapse('toggle')});
$(function () { $(".popovernya").popover({html : true}); });
</script>
</div><!--fluid-->
</body>