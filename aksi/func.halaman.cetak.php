...
function showPagination($tableName, $limit = 20)
{
    ...
    $page = 1;
    echo '<ul class="pagination pagination-sm" style="float:right;margin-top:-40px;"><li><a href="#"><strong>Halaman</strong></a></li>';
    while ($page <= $totalPage)
    {	
	
        echo '<li><a href="?hal=cetakkartu&page='.$page.'&perPage='.$limit.'">'.$page.'</a></li>';
