...
<h4><a style="font-style:italic;text-transform:uppercase;"><?php echo $data['judul_file']; ?></a> Diupload Oleh :</h4>
...
$lokasi_foto = "../foto/".$fotonya['foto']; 
  ...
  <tr>
	...
	echo '<tr><td>'.$nomoru++.'</td><td><img src="../pengaturan/img/pdf.gif"> '.$ini['judul_file'].'</td><td><a href="../aksi/bacaebookn.php?id='.$ini['id_file'].'"><button class ="btn btn-primary btn-xs">Baca</button></a></td><td><a href="../aksi/adm_hapus_ebook.php?id='.$ini['id_file'].'"><button class="btn btn-danger btn-xs">Hapus</button></td></tr>';
	}
	?>
    </table>
    </div>
...
/* masih salah 
if($komentarnya == "[senyum]"){
	$emoticon = "smile.PNG";
	$emot = "../pengaturan/emoticon/";
	$kome  = '<img src="'$emot.$emoticon'"/>';
} else if ($komentarnya == "[kaget]"){
	$emoticon = "startle.PNG";
	$emot = "../pengaturan/emoticon/";
	$komen  = '<img src="'$emot.$emoticon'"/>';
} else if ($komentarnya == "[marah]"){
	$emoticon = "anger.PNG";
	$emot = "../pengaturan/emoticon/";
	$kome  = '<img src="'$emot.$emoticon'"/>';
} else if ($komentarnya == "[nagis]"){
	$emoticon = "cry.PNG";
	$emot = "../pengaturan/emoticon/";
	$kome  = '<img src="'$emot.$emoticon'"/>';
} else if ($komentarnya == "love"){
	$emoticon = "love.PNG";
	$emot = "../pengaturan/emoticon/";
	$kome  = '<img src="'$emot.$emoticon'"/>';
} else if ($komentarnya == "[keren]"){
	$emoticon = "cool.PNG";
	$emot = "../pengaturan/emoticon/";
	$kome  = '<img src="'$emot.$emoticon'"/>';
} else if ($komentarnya == "[bingung]"){
	$emoticon = "confused.PNG";
	$emot = "../pengaturan/emoticon/";
	$kome  = '<img src="'$emot.$emoticon'"/>';
} else if ($komentarnya == "[tanya]"){
	$emoticon = "question.PNG";
	$emot = "../pengaturan/emoticon/";
	$kome  = '<img src="'$emot.$emoticon'"/>';
} else if ($komentarnya == "[heran]"){
	$emoticon = "sweat.PNG";
	$emot = "../pengaturan/emoticon/";
	$kome  = '<img src="'$emot.$emoticon'"/>';
}
